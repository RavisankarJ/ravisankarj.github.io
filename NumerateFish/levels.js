...
export class TwoOperands{
    ...
    drawQuestion(){
        ...
        this.game.ctx.fillText(this.game.operationChar, this.game.width - 220, 90);
        this.game.ctx.fillText('= '+this.game.questionNumber, this.game.width - 105, 90);
        this.game.ctx.fillStyle = 'white';
        this.game.ctx.fill();
        this.game.ctx.fillStyle = 'black';
        this.game.ctx.fillText(this.game.boxNumbers[0], this.game.width - 272, 87);
        this.game.ctx.fillText(this.game.boxNumbers[1], this.game.width - 167, 87);
    }
}
export class ThreeOperands{
    ...
    drawQuestion(){
        ...
        this.game.ctx.fill();
        this.game.ctx.fillStyle = 'black';
        this.game.ctx.fillText(this.game.operationChar, this.game.width - 275, 90);
        this.game.ctx.fillText(this.game.operationChar, this.game.width - 185, 90);
        this.game.ctx.fillText('= '+this.game.questionNumber, this.game.width - 95, 90);
        this.game.ctx.fillText(this.game.boxNumbers[0], this.game.width - 327, 87);
        this.game.ctx.fillText(this.game.boxNumbers[1], this.game.width - 237, 87);
        this.game.ctx.fillText(this.game.boxNumbers[2], this.game.width - 147, 87);
    }
}
...
export class Level5_2 extends Factors{
    ...
    enter(){
        this.game.questionNumber = Math.round(Math.random()*6+4) * Math.round(Math.random()*4+2);
        this.game.winningScore = 5;
        super.enter();
    }
    createBubbleValues(){
