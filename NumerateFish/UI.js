export class UI {
    ...
    draw(context) {
        ...
        //score
        context.fillText(' : '+this.game.coins, (this.game.width/3.7)+260/4, 100);
        ...
        context.drawImage(this.coincollectionimage,  (this.game.width/3.7), 100-194/7, 260/4, 194/4);
